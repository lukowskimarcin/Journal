...
@SpringBootTest
public class EmbracingBullTests {
    private List<CandleStickDto> data = new ArrayList<>();
    private EmbracingBull pattern;
    ...
    @BeforeEach
    void setup() {
        pattern = new EmbracingBull(config);
    ...
    void buyAtTop() {
        ...
        data.add(new CandleStickDto(7l, "", 180.0, 1250.0, 1100.0, 1220.0, 0l, 0l, 0l, 0.0, false, 0.0));
        PatternDto result = pattern.match(data);
    ...
    void tooLongShadowTrap() {
        data.add(new CandleStickDto(6l, "", 200.0, 200.0, 100.0, 100.0, 0l, 0l, 0l, 0.0, false, 0.0));
        data.add(new CandleStickDto(7l, "", 80.0, 650.0, 100.0, 220.0, 0l, 0l, 0l, 0.0, false, 0.0));
        PatternDto result = pattern.match(data);
